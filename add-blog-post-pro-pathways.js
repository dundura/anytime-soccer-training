...
const newPost = {
  id: maxId + 1,
  title: "Your Kid Didn't Make a Pro Academy. Now What? A Parent's Guide to UPSL, USL Academy, NPSL, and USL League Two",
  slug: "usl-academy-upsl-npsl-usl-league-two-parent-guide",
  date: "Wed, 12 Aug 2026 10:00:00 +0000",
  content,
  excerpt: "If your 16-year-old isn't in an MLS Next or USL Championship academy, it can feel like the door to professional soccer just closed. It hasn't — it just means a different set of doors. Here's the full breakdown of USL Academy, UPSL, NPSL, and USL League Two: who plays, when the season runs, what it costs, and exactly how each one affects NCAA eligibility.",
