      ...
      <section className="py-4 px-5 bg-white">
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <div className="bg-red/[0.06] border-2 border-red/20 rounded-2xl p-8">
            ...
            <p className="text-xs text-red font-bold mt-3">Start with a free account — when you&apos;re ready to unlock the full program, just enter your code and the discount is applied instantly.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-4 px-5 bg-background text-center">
        <div className="max-w-[600px] mx-auto">
          ...
          <p className="text-gray text-lg mb-8">
            Join thousands of players already training with Anytime Soccer.
          </p>
          <a
            href="https://www.anytime-soccer.com/pricing"
