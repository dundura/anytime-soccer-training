...
const faqs = [
  { q: 'Is Anytime Soccer Training really free?', a: 'Yes! You can join for free and access free training sessions forever. Premium plans start at just $59.98/year for individuals and $10/player/year for teams.' },
