    ...
    <>
      ...
      <div className="bg-background pb-4 -mt-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-navy rounded-2xl p-6 flex items-center gap-6 flex-wrap">
            <img
            ...
            <div className="flex-1 min-w-0">
              ...
              <ul className="list-none p-0 m-0 flex flex-col gap-1">
                ...
                <li className="text-white/90 text-sm whitespace-nowrap">&#10004; Only <strong className="text-[#22C55E]">$6 per player per year</strong></li>
              </ul>
            </div>
            <a
      ...
      <section className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {(postsData as { slug: string; title: string; date: string; categories: string[]; featuredImage: string; content: string; excerpt: string }[])
