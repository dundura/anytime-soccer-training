        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={card.title} className="bg-white rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(15,49,84,0.08)]">
                ...
                <div className="p-6 pt-4">
                  <p className="text-red font-semibold text-sm">{card.caption}</p>
                </div>
              </div>
            ))}
          </div>
