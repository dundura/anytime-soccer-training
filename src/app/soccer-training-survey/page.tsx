...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://d2vm0l3c6tu9qp.cloudfront.net/soccer-directory/uploads/1789411035321-dyv6yn.png' }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['https://d2vm0l3c6tu9qp.cloudfront.net/soccer-directory/uploads/1789411035321-dyv6yn.png'],
  },
};
