  ...
  return (
    <main>
      <section className="bg-[#0f2642] py-10 md:py-16">
        <div className="max-w-[1100px] mx-auto px-5 flex flex-col md:flex-row items-center gap-10">
          ...
          {/* Right: image */}
          <div className="w-full md:w-[420px] flex-shrink-0 rounded-2xl overflow-hidden shadow-2xl">
            <img
