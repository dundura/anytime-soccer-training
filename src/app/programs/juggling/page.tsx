...
export const metadata: Metadata = {
  ...
  description: 'Step-by-step juggling progression from zero to 1,000. Build aerial control and first touch.',
};
    ...
    <>
      <section className="bg-navy text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Juggling & Aerial Control</h1>
          <p className="text-xl text-white/80">
            Step-by-step progression from zero to 1,000. Build aerial control, balance, and first touch.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {['Beginner to Advanced Progressions', 'Partner Juggling', 'Tennis Ball Training', 'Aerial Finishing', 'Ball Control in Air', 'Juggling Challenges'].map((item) => (
