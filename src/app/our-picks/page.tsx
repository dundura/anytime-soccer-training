...
const SECTIONS: Section[] = [
  {
    ...
    products: [
      { title: 'Adidas MLS Training Soccer Ball', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/adidas-mls-soccer-ball.jpg', href: 'https://amzn.to/4q6yUY3' },
      { title: 'Disc Training Cones (Set of 40)', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/training-cones.jpg', href: 'https://amzn.to/4soWKzv' },
      { title: 'PUGG Pop-Up Soccer Goals (Set of 2)', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/popup-goals.jpg', href: 'https://amzn.to/4qA1Kj9' },
      { title: 'Soccer Rebounder', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/soccer-rebounder.jpg', href: 'https://amzn.to/4qFkfD1' },
      { title: 'Bluetooth Speaker', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/blue_tooth_speaker.jpg', href: 'https://amzn.to/4sGL2Rc' },
      { title: 'Agility Ladder Set', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/soccer_agility_ladder.jpg', href: 'https://amzn.to/4spLHX1' },
      { title: 'Size One Soccer Ball', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/size_one-soccer-balls.jpg', href: 'https://amzn.to/4aM3st9' },
      { title: 'Portable Ball Pump', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/portable_ball_pump.jpg', href: 'https://amzn.to/3YZtSQU' },
    ],
  },
  {
    id: 'rebounders',
    ...
    products: [
      { title: 'A-Champs RebounderGo - Smart Training Rebounder with Lights & Sensors', image: 'http://media.anytime-soccer.com/wp-content/uploads/2025/07/a-champs_rebounder.webp', href: 'https://a-champs.com/collections/soccer-training-equipment?sca_ref=9165467.J8S7aW63u8&utm_source=uppromote&utm_medium=affiliate&utm_campaign=neil-crawford', cta: 'Buy Now - $269' },
      { title: 'QuickPlay REPLAY Station - Most Portable Rebounder', image: 'http://media.anytime-soccer.com/wp-content/uploads/2025/09/replay-station-xl-best-rebound-board-soccer_1482x1482.webp', href: 'https://amzn.to/4mQFcsT', cta: 'Buy Now - $89-$179' },
      { title: 'SteelRebound with HDPE Board - Best Budget Portable Rebounder', image: 'http://media.anytime-soccer.com/wp-content/uploads/2025/09/s-l1600-1.webp', href: 'https://amzn.to/4njgP73', cta: 'Buy Now - $119' },
      { title: 'Portable Rebound Net - Simple & Affordable', image: 'http://media.anytime-soccer.com/wp-content/uploads/2026/01/soccer-rebounder.jpg', href: 'https://amzn.to/465vYSw' },
    ],
  },
];
