    ...
    <>
      ...
      <section className="pt-6 pb-16 md:pt-8 md:pb-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl px-6 pt-16 pb-6 md:px-12 md:pt-20 md:pb-8 relative overflow-hidden text-center shadow-[0_2px_12px_rgba(15,49,84,0.08)]">
