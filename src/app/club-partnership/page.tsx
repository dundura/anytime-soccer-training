      ...
      <section className="bg-gradient-to-b from-background to-white py-16 md:py-20">
        <div className="max-w-[1000px] mx-auto px-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="text-center">
              <img
                src="http://media.anytime-soccer.com/wp-content/uploads/2026/01/microsoftteams-image.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div className="text-center order-2 lg:order-1">
              <img
                src="http://media.anytime-soccer.com/wp-content/uploads/2026/01/microsoftteams-image-2.jpg"
