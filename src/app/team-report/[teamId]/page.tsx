              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <th className="hidden sm:table-cell px-3 py-1 text-center text-[9px] font-black text-purple-700 uppercase tracking-widest border-l border-gray-100 bg-purple-50/70" colSpan={CHECKLIST_ITEMS.length - 6}>Building Team Culture</th>
                  </tr>
