...
export const ONBOARDING_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer: `
      <p><strong>Set personal player challenges.</strong> This is the single biggest driver of consistency &mdash; when a player has their own target, they show up.</p>
