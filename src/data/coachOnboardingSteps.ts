...
export const COACH_ONBOARDING_STEPS: CoachOnboardingStep[] = [
  ...
  },
  {
    ...
    body: `
      <p><strong>If you submitted a roster:</strong> we&rsquo;ll send your invoice via Stripe. Once paid, confirm this step below &mdash; that&rsquo;s when onboarding begins.</p>
  ...
  },
  {
    title: 'Roster FAQs',
    body: `
      <p>Roster templates are for teams joining Anytime Soccer Training for the first time. Renewing members can submit a roster or add new players inside the app. Before you download the roster template, we want to cover some FAQs.</p>
    `,
  },
  {
