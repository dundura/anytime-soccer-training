    ...
    body: (
      <ol className="space-y-3">
        {[
          ...
          <>Profiles share the same login email, but can have a unique <strong className="text-navy font-semibold">contact email</strong> (it can even be the same as your login email).</>,
