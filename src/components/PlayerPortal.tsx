    ...
    body: (
      <ol className="space-y-3">
        {[
          ...
          <>Profiles share the same login email, but can have unique <strong className="text-navy font-semibold">contact emails</strong> (they can even be the same as your login email).</>,
