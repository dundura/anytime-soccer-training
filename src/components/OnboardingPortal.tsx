...
const COACH_PORTAL_STEPS: PortalStep[] = [
  ...
  { key: 'roster_intro', title: 'Overview: Upgrading Players', dataIndex: 22, section: 'Pre-Onboarding', info: true, quiz: { prompt: 'Confirm before continuing:', options: ['I understand that within 7 days of joining my team, I need to apply free access slots to my players'] } },
