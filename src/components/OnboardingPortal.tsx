...
{ key: 'faq_intro', title: 'Common FAQs', dataIndex: 16, section: 'FAQs', info: true },
  ...
  { key: 'commit_contest', title: '1. Start a team contest', dataIndex: -1, faqIndex: 25, section: 'FAQs', tip: true, quiz: { prompt: 'I plan to start a team contest and announce it at my next training.', options: ['Yes', 'No'] } },
  { key: 'commit_goals', title: '2. Set a personal challenge for every player', dataIndex: -1, faqIndex: 26, section: 'FAQs', tip: true, quiz: { prompt: 'I plan to take a few seconds to set a personal challenge for every player.', options: ['Yes', 'No'] } },
  { key: 'commit_demo', title: '3. Demo the app in person', dataIndex: -1, faqIndex: 27, section: 'FAQs', tip: true, quiz: { prompt: 'I plan to demo the app in person and relay questions to Megan if necessary.', options: ['Yes', 'No'] } },
