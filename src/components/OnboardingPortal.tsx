...
const COACH_PORTAL_STEPS: PortalStep[] = [
  ...
  { key: 'add_profiles', title: 'Add profiles', dataIndex: 20, section: 'Onboarding' },
...
const DIRECTOR_PORTAL_STEPS: PortalStep[] = [
  ...
  { key: 'dir_example', title: 'Example', dataIndex: 3, section: 'Your Club', info: true },
  { key: 'dir_onboarding', title: 'How onboarding works', dataIndex: 4, section: 'Your Club', info: true },
  { key: 'dir_seasons', title: 'Adding and removing players each season', dataIndex: 5, section: 'Your Club', info: true },
  { key: 'dir_coaches', title: 'Getting your coaches set up', dataIndex: 6, section: 'Rolling Out' },
  { key: 'dir_parents', title: 'Rolling it out to parents', dataIndex: 7, section: 'Rolling Out' },
  { key: 'final_confirm', title: 'Talk to Megan', dataIndex: 8, section: 'Rolling Out', final: true },
];
