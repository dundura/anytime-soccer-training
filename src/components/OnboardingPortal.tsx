...
{ key: 'faq_intro', title: 'Common FAQs', dataIndex: 16, section: 'FAQs', info: true },
  ...
  { key: 'commit_goals', title: '2. Set personal player challenges', dataIndex: -1, faqIndex: 26, section: 'FAQs', tip: true, quiz: { prompt: 'I plan to take a few seconds to set a personal challenge for every player.', options: ['Yes', 'No'] } },
